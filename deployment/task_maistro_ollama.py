...
model = ChatOllama(model="qwen3:8b", temperature=0.0, base_url="http://host.docker.internal:11434")
...
def task_mAIstro(state: MessagesState, config: RunnableConfig, store: BaseStore):
   ...
   # Retrieve profile memory from the store
    ...
    # if isinstance(model, ChatOpenAI) else model.bind_tools([UpdateMemory])
